import { EmailValueObject } from '@/shared/domain/value-objects/contact/email-value-object'
...
describe('EmailValueObject', () => {
  ...
  it('should throw error for invalid email', () => {
    ...
    invalidEmails.forEach(email => {
      expect(() => new EmailValueObject(email)).toThrowError('Invalid email format')
    })
  })
