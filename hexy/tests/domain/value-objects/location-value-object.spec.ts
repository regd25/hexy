import { LocationValueObject } from '@/shared/domain/value-objects/location/location-value-object'
...
describe('LocationValueObject', () => {
  ...
  it('should throw error for invalid coordinates', () => {
    ...
    invalidCoordinates.forEach(coord => {
      expect(() => new LocationValueObject(coord.lat, coord.lng)).toThrowError('Invalid geographic coordinates')
    })
  })
