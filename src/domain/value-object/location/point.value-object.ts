 ...
 */
export class Point extends ValueObject<Coordinates> {
	...
	validate(value: Coordinates): boolean {
		return (
			value.latitude instanceof Latitude && value.longitude instanceof Longitude
		)
	}
