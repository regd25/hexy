import type { StringRecord } from 'core/types'
import type { PostgresAdapterResult } from './postgres-adapter-result'
import type { Adapter, FilterPrimitives } from 'core/port'
import type { PostgresAdapterQuery } from './postgres-adapter-query'
...
export class PostgresCriteriaAdapter
	implements Adapter<PostgresAdapterQuery, PostgresAdapterResult>
{
	/**
	 ...
	 */
	adapt(_query: PostgresAdapterQuery): PostgresAdapterResult {
