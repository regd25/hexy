...
export const useModuleValidation = (customRules: ValidationRule[] = []): UseModuleValidationReturn => {
    const validationRules = useMemo(() => [...defaultValidationRules, ...customRules], [customRules])
    ...
    const getValidationErrors = useCallback(
        (data: ModuleData): Record<string, string[]> => {
    ...
    const validate = useCallback(
        (data: ModuleData): ValidationResult => {
