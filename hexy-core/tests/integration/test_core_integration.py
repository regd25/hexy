...
class TestCoreIntegration:
    ...
    def test_event_system_integration(self):
        ...
        purpose = Purpose(
            id="event-test", name="Event Test", description="Testing events"
        )
    ...
    def test_plugin_system_integration(self):
        ...
        result = self.plugin_manager.execute_plugin(
            "aws-cdk-deployment", "deploy", {"stack_name": "test-stack"}
        )
    ...
    def test_semantic_search_integration(self):
        ...
        artifacts = [
            Purpose(
                ...
                description="Transform culture to transparency",
            ),
            Context(
                id="c1", name="Latam Context", description="Operations in Latin America"
            ),
            Authority(
                id="a1", name="Board Authority", description="Executive board decisions"
            ),
            Evaluation(
                id="e1",
                name="Success Metrics",
                description="Measure transparency success",
            ),
        ]
        ...
        assert (
            "Transparency Purpose" in artifact_names
            or "Success Metrics" in artifact_names
        )
    ...
    def test_error_handling_integration(self):
        ...
        invalid_artifact = Purpose(
            id="", name="", description=""  # Invalid ID  # Invalid name
        )
